...
const initialState: ISliceState = {
   list: [],
   item: newAppraisalPeriod,
   formState: '',
   formResult: null,
   triggerApi: false,
}

const appraisalPeriodSlice = createSlice({
...
export default appraisalPeriodSlice.reducer;

export const { itemAdded, itemUpdated, itemDeleted }
   = appraisalPeriodSlice.actions;
export const { listChanged, itemChanged, formStateChanged, formResultChanged, triggerApiChanged, sliceChanged }
   = appraisalPeriodSlice.actions;