...
import {
    useGetGoalBatchesPendingApprovalQuery, useLazyGetGoalBatchesPendingApprovalQuery
...
import mockData from '../../features/goals/mockData';
...
const BrowseTeamGoals = (): JSX.Element => {
...
export default BrowseTeamGoals;