...
const GoalBatchReviewWrapper = (props: { currentUserUPN: string }): JSX.Element => {
   ...
   const { filteredData, error, isLoading, isFetching, refetch } = useGetAllUserGoalsOldQuery(userUPN!, {
   ...
   return (
      <>{isLoading ? (
         ...
         <>
            <OverviewPage isLoading={isLoading} items={items} user={selectedUser} />
...
export default GoalBatchReviewWrapper;